            ...
            <div className="footer-section">
                <div className="section">
                    ...
                    <ul className="section-text">
                        ...
                        <li className="section-link"><a href="/attend" className="text-primary">Book</a></li>
                    </ul>
                </div>
                <div className="section">
                ...
                <div className="section">
                    ...
                    <ul className="section-text">
                        <li className="section-link"><a href="/tickets" className="text-primary">Tickets</a></li>
                        <li className="section-link"><a href="/shares" className="text-primary">Shares</a></li>
                    </ul>
                </div>
                <div className="section">
                    ...
                    <div className="social-row">
                        ...
                        <a href="" target="_blank" rel="noopener noreferrer"> {/* Add your facebook links here */}   
                                <img src={facebook} alt="Facebook" className="social-icon" /> 
                            </a>
                        </div>
                        <div className="soc-item">
                            <a href="" target="_blank" rel="noopener noreferrer"> {/* Add your X links here */}
